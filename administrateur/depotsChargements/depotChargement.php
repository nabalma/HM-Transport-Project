...
class DepotChargement{
    ...
    public function insertData($post){
        ...
        $var_Designation_Depot_Chargement_target= $this->con->real_escape_string($_POST['designation']);
