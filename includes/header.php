...
<body>
    <!--Header-->
    <nav class="invisible navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-1 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="login.php">Acceuil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disable" href="#">Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disable" href="#">Superviseur</a>
                    </li>
                    <li class="nav-item dropdown">
                      ...
                      Gestion Opérations
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item nav-link disable" href="#">Gestionnaire Camions</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item nav-link disable" href="#">Gestionnaire Chauffeurs</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item nav-link disable" href="#">Gestionnaire Voyages</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
