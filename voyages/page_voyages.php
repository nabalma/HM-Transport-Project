...
<div class="mt-1 container">
  ...
  <div class="row mb-2 d-flex justify-content-around">
    ...
    <div class="mt-2 col">
      <a href="sauvegardeVoyage.php" class="btn btn-black border border-secondary border-2 fs-6 rounded-pill"style="font-family:verdana">
          <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" preserveAspectRatio="xMidYMid meet" viewBox="0 0 36 36"><path fill="black" d="M30.86 8.43A2 2 0 0 0 28.94 7H7.06a2 2 0 0 0-1.93 1.47L2.29 20h31.42Z" class="clr-i-solid clr-i-solid-path-1"/><path fill="#C70039" d="M2 22v7a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2v-7Zm28 5h-4v-2h4Z" class="clr-i-solid clr-i-solid-path-2"/><path fill="none" d="M0 0h36v36H0z"/>
          </svg>BACK UP
      </a>
