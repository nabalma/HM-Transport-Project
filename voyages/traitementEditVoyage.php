...
$freinte=$_POST['freinte'];
$volfacture=$_POST['volfacture'];
...
//Dans le cas ou il sagit du premier voyage, la ref voyage precedente est inexistante, la mise a jour est faite sans tenir compte des champs refVoyagePrecedt et dateRetourVoyage precedt
if($voyPrec==null){
    $sql = "UPDATE voyages SET req_Transporteur='$reqTransporteur', depot_de_chargement='$depotChargement', depot_de_livraison='$depotLivraison', ref_Chauffeur_Voyage='$chauffeur', ref_Camion_Voyage='$camion', ref_Transitaire='$transitaire', bon_dEnlevement_Sonabhy='$besonabhy', tournee_Marketer='$tournee', ordre_de_Chargement_Marketer='$numoc', plan_de_Voyage='$planvoyage', bL_Livraison_Client='$numbl', volume_livre='$vollivre', volume_coulage='$coulage', statutVoyage='$statutVoyage', freinte='$freinte', volumeFacture='$volfacture', dateOC='$dateOC', dateBonSbhy='$dateBonSbhy', dateDepart='$dateDepart', dateArrFrtAllee='$dateArrFrtAllee', dateArrDepChargmt='$dateArrDeptChrgt', dateChargmt='$dateChrgt', dateDepaDepChrgmt='$dateDeparDptChrgmt', dateArrFrtRetour='$dateArrFrtRetour', dateArrOuaga='$dateArrOuaga', dateSortieBingo='$dateSortieBingo', dateArrSurSite='$dateArrSurSite', dateLivraison='$dateLivraison', dateSortieDuSite='$dateSortieSite', dateRetourDuSite='$dateRetour', dateInspection='$dateInspection', dateCorrectionInspect='$dateCorrInspect', dateAnalyseOBCSuiv='$dateAnnalySuiv', Commentaires='$commentaires' WHERE ref_Voyage='$refVoyage'";
}
else // Dans le cas ou il exitse la ref voyage precedente, la mise a jour est faite en tenant compte de tous les champs, y compris des champs refVoyagePrecedt et dateRetourVoyage precedt
{
    $sql = "UPDATE voyages SET req_Transporteur='$reqTransporteur', depot_de_chargement='$depotChargement', depot_de_livraison='$depotLivraison', ref_Chauffeur_Voyage='$chauffeur', ref_Camion_Voyage='$camion', ref_Transitaire='$transitaire', bon_dEnlevement_Sonabhy='$besonabhy', tournee_Marketer='$tournee', ordre_de_Chargement_Marketer='$numoc', plan_de_Voyage='$planvoyage', bL_Livraison_Client='$numbl', volume_livre='$vollivre', volume_coulage='$coulage', statutVoyage='$statutVoyage', freinte='$freinte', volumeFacture='$volfacture', refVoyPrec='$refVoyPrec', dateArrVoyPrec='$dateArrVoyPrec', dateOC='$dateOC', dateBonSbhy='$dateBonSbhy', dateDepart='$dateDepart', dateArrFrtAllee='$dateArrFrtAllee', dateArrDepChargmt='$dateArrDeptChrgt', dateChargmt='$dateChrgt', dateDepaDepChrgmt='$dateDeparDptChrgmt', dateArrFrtRetour='$dateArrFrtRetour', dateArrOuaga='$dateArrOuaga', dateSortieBingo='$dateSortieBingo', dateArrSurSite='$dateArrSurSite', dateLivraison='$dateLivraison', dateSortieDuSite='$dateSortieSite', dateRetourDuSite='$dateRetour', dateInspection='$dateInspection', dateCorrectionInspect='$dateCorrInspect', dateAnalyseOBCSuiv='$dateAnnalySuiv', Commentaires='$commentaires' WHERE ref_Voyage='$refVoyage'";
}
